...
AP SMS Manager helps you turn your website into an SMS as a service web app. It makes it a breeze to send bulk sms messages to your contacts, using pre-registered gateways.
...
* Minor Bugfix: Fix sms data after its sent to the server.

= 0.0.5 =
*Release Date - 22 May 2022*
* Minor Bugfix: Bumped Version Up
...
Or you can quickly shoot us a mail at support@appsbay.xyz

= The Minimum PHP Required =
...
If you are having trouble upgrading, maybe we can help. Shoot us a mail at support@appsbay.xyz

= The Minimum Browser Required =
...
either on the forum or by sending us a mail directly here: support@appsbay.xyz

== Upgrade Notice ==
This section will soon be updated if there is any upgrade.

== Screenshots ==
1. The Dashboard with charts
2. The Send SMS page
3. Add contacts.
4. Sync with phone numbers collected by other plugins, like, Woocomerce
5. Input phone numbers manually
6. The contacts list page
7. Groups list page
8. Delivery reports page
9. Gateways API Integration, where you register your preferred gateways from the list of supported gateways.
10. Settings page where you can change the color themes of the entire app.
